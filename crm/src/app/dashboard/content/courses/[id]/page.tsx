            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex gap-2">
                <Button onClick={addModule} disabled={saving}>
                  {saving ? 'Zapisywanie...' : 'Zapisz moduł'}
                </Button>
        ...
        {modules.length === 0 ? (
          <Card>
            <CardContent className="py-8 text-center text-gray-500">
              Brak modułów – dodaj pierwszy moduł
            </CardContent>
          </Card>
        ) : (
                    ...
                    <div className="border rounded-lg p-4 bg-gray-50 space-y-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          <Button
                            variant="outline"
                            onClick={() => fetchYouTubeData(newLesson.video_url)}
                            disabled={fetchingYT || !newLesson.video_url}
                          >
                            {fetchingYT ? 'Pobieranie...' : 'Pobierz dane'}
                          </Button>
                        </div>
                        <p className="text-xs text-gray-400">Wklej link i kliknij "Pobierz dane" – tytuł i czas zostaną uzupełnione automatycznie</p>
                      </div>
                      <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor={`preview-${mod.id}`}>Bezpłatny podgląd (widoczny bez subskrypcji)</Label>
                      </div>
                      <div className="flex gap-2">
